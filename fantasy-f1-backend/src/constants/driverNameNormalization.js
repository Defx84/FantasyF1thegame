/**
 * Season-aware Driver Name Normalization
 * Creates normalization functions for a specific season's driver data
 */

function createDriverNormalization(drivers) {
    ...
    function normalizeDriverName(name) {
        ...
        try {
            ...
            console.error('Error in normalizeDriverName:', error, 'Input:', name);
...
// For backward compatibility, export 2025 normalization by default
const { F1_DRIVERS_2025 } = require('./f1DriverData');
const defaultNormalization = createDriverNormalization(F1_DRIVERS_2025);

module.exports = {
    createDriverNormalization,
    // Default exports for backward compatibility (2025)
    normalizeDriverName: defaultNormalization.normalizeDriverName,
    isValidDriver: defaultNormalization.isValidDriver,
    getDriverNameVariations: defaultNormalization.getDriverNameVariations,
    driverNameToShortName: defaultNormalization.driverNameToShortName
}; 